...
Переключение происходит с помощью команды:

    git checkout <branch_name>

### Команда показывающая историю ветвлений и слияний 

Выполняется командой:

    git log --graph

 ### Команда показывающая историю ветвлений,слияний,коммитов в формате диаграммы
...
### Удаление ветки
 ...
 Удаление ветки происходит на той ветке, в которую заливают информацию с ветки которую в последствии удаляют.
...
Хорошего и легкого вам обучения =)) 
